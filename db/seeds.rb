...
rsvp4 = Rsvp.create!(event_id: 1, user_id: 4)
rsvp5 = Rsvp.create!(event_id: 1, user_id: 5)
rsvp6 = Rsvp.create!(event_id: 3, user_id: 7)
rsvp7 = Rsvp.create!(event_id: 3, user_id: 8)
